#ifndef HAVOQGT_APPROXIMATE_PATTERN_MATCHING_TOKEN_PASSING_PATTERN_MATCHING_NONUNIQUE_TDS_BATCH_5_HPP_INCLUDED
#define HAVOQGT_APPROXIMATE_PATTERN_MATCHING_TOKEN_PASSING_PATTERN_MATCHING_NONUNIQUE_TDS_BATCH_5_HPP_INCLUDED
...
//  auto pattern_selected_vertices = std::get<5>(pattern_utilities.input_patterns[pl]); // boolean
  ...
  auto pattern_selected_vertices = 0;

  // TODO: not used here, so remove
  //auto pattern_is_tds = std::get<4>(ptrn_util_two.input_patterns[pl]); // boolean
  //auto pattern_interleave_label_propagation = std::get<5>(ptrn_util_two.input_patterns[pl]); // boolean
...
#endif //HAVOQGT_APPROXIMATE_PATTERN_MATCHING_TOKEN_PASSING_PATTERN_MATCHING_NONUNIQUE_TDS_BATCH_55555_HPP_INCLUDED
